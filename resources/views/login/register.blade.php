...
<div style="display: flex; align-items; margin-bottom: 15px; padding: 12px 0; border-bottom: 1px solid #f0f0f0;">
...
<ul>
 	...
 	<li><a class="gt3_icon_link gt3_custom_color" href="#" target="_blank" data-color="#5747e4" data-hover-color="inherit" style="font-size: 14px; color: #5747e4;" rel="noopener"><i class="fa fa-check"> </i></a>  Assistance technique</li>
</ul>
